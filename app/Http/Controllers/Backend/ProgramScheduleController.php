...
class ProgramScheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        $schedule = ProgramSchedule::orderBy('id', 'desc')->with('program')->get();
        return view('backend.program.schedule.index', compact('schedule'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.program.schedule.create', compact('program'));
    }
    ...
    public function edit($id)
    {
        ...
        $program = ProgramList::where('status', '1')->orderBy('id', 'desc')->get();
        return view('backend.program.schedule.edit', compact('program', 'schedule'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.program.schedule.index');
        } catch (Exception $error) {
            Session::flash('type', 'error');
            Session::flash('message', $error->getMessage());
            return redirect()->back();
