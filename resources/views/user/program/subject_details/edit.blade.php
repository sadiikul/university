    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Subject Details Edit</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('user.program.subject.index') }}">Subject Details</a>
                            </li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('user.program.subject.index') }}" class="btn btn-sm btn-info"><i
                                        class="fas fa-arrow-left"></i> Back</a>
                            </div>
                            <!-- /.card-header -->
                            <form action="{{ route('user.program.subject.update', $subject->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                            ...
                                            <div class="col-md-9">
                                                <select name="program" required
                                                    ...
                                                    @foreach ($program as $item)
                                                        <option {{ $item->id === $subject->program_id ? 'selected' : '' }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="prerequisite"
                                                    placeholder="Enter prerequisite..." value="{{ $subject->prere }}"
                                                    class="form-control rounded-0 form-control-sm @error('prerequisite') is-invalid @enderror">
                                                @error('prerequisite')
                                                    <div class="text-danger font-italic">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="description" class="medium">{{ $subject->desc }}</textarea>
                                                @error('description')
                                                    <div class="text-danger font-italic">
                                                        {{ $message }}
                                                    </div>
