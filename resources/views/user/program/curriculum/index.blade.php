                    ...
                    <div class="col-12">
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('user.program.curriculum.create') }}" class="btn btn-sm btn-primary"><i
                                        ...
                                        @foreach ($list as $val)
                                            @foreach ($val->curr as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a title="Edit"
                                                            href="{{ route('user.program.curriculum.edit', $item->id) }}"
                                                            class="text-info mx-1"><i class="fas fa-edit"></i></a>
                                                        <a title="Delete"
                                                            onclick="return confirm('Are you sure to Delete?')"
                                                            href="{{ route('user.program.curriculum.destroy', $item->id) }}"
