                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('user.notice.index') }}">Notice</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('user.notice.index') }}" class="btn btn-sm btn-info"><i
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="content_type" required
                                                    ...
                                                    <option {{ $notice->content_type == 'text' ? 'selected' : '' }}
                                                        value="text">Text</option>
                                                    <option {{ $notice->content_type == 'image' ? 'selected' : '' }}
                                                        value="image">Image</option>
                                                    <option {{ $notice->content_type == 'pdf' ? 'selected' : '' }}
                                    ...
                                    <div id="img" class="form-group @if ($notice->content_type !== 'image') d-none @endif">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="file" data-default-file="{{ asset($notice->file) }}"
                                                    name="image" class="dropify" data-height="1000">
                                    ...
                                    <div id="pdf" class="form-group @if ($notice->content_type !== 'pdf') d-none @endif">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <iframe src="{{ asset($notice->file) }}" frameborder="0" class="mt-2"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="status" required
                                                    ...
                                                    <option {{ $notice->status == 1 ? 'selected' : '' }} value="1">
                                                        Active
                                                    </option>
