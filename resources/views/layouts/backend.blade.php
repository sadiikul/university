...
<body
    class="hold-transition @if (!Route::is('login') && !Route::is('forgot') && !Route::is('new.password'))) sidebar-mini layout-fixed text-sm layout-navbar-fixed @else login-page @endif">
    @if (!Route::is('login') && !Route::is('forgot') && !Route::is('new.password'))
        <div class="wrapper">
            <!-- Navbar -->
