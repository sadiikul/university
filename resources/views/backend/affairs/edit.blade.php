    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Person Edit</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.affairs.index') }}">Person</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('admin.affairs.index') }}" class="btn btn-sm btn-info"><i
                                        class="fas fa-arrow-left"></i> Back</a>
                            </div>
                            <!-- /.card-header -->
                            <form action="{{ route('admin.affairs.update', $affairs->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" required name="designation"
                                                    placeholder="Enter designation..." value="{{ $affairs->desig }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="file" name="image" class="dropify" data-height="100"
                                                    data-default-file="{{ asset($affairs->img) }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="status" required
                                                    ...
                                                    <option {{ $affairs->status == 1 ? 'selected' : '' }} value="1">
                                                        Active
                                                    </option>
                                                    <option {{ $affairs->status == 0 ? 'selected' : '' }} value="0">
                                                        Inactive
                                                    </option>
                                                </select>
                                                @error('status')
