                    ...
                    <div class="col-12">
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('admin.management.syndicate.create') }}" class="btn btn-sm btn-primary"><i
                                    ...
                                    <tbody>
                                        @foreach ($member as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-secondary">{{ $item->position == 1 ? 'top':'bottom' }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                        class="badge 
                                                ...
                                                <td>
                                                    <a title="Edit" href="{{ route('admin.management.syndicate.edit', $item->id) }}"
                                                        class="text-info mx-1"><i class="fas fa-edit"></i></a>
                                                    <a title="Delete" onclick="return confirm('Are you sure to Delete?')"
                                                        href="{{ route('admin.management.syndicate.destroy', $item->id) }}"
