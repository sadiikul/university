    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Pro Vice Chancellor</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.management.chancellor.pro.edit') }}">Chancellor</a>
                            </li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Edit Pro Vice Chancellor</h3>
                            </div>
                            <!-- /.card-header -->
                            <form action="{{ route('admin.management.chancellor.pro.update',$pro->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="file" data-default-file="{{ asset($pro->img) }}" name="image" class="dropify"
                                                    data-height="100">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="short" class="form-control rounded-0 form-control-sm @error('short') is-invalid @enderror" rows="5">{{ $pro->short }}</textarea>
                                                @error('short')
                                                    <div class="text-danger font-italic">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="long" class="long">{{ $pro->long }}</textarea>
                                                @error('long')
                                                    <div class="text-danger font-italic">
                                                        {{ $message }}
                                                    </div>
