<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="p-3 text-center">
        ...
        <div class="admin_profile">
            ...
            <a href="{{ route('admin.profile.edit') }}"><i class="fas fa-edit mr-1"></i> Edit
                Profile</a>
            <a href="{{ route('admin.profile.password.edit') }}"><i class="fas fa-lock mr-1"></i> Change
                Password</a>
            <!--Log out -->
            <a onclick="return confirm('Are you sure to logout?')" href="{{ route('admin.logout') }}"><i class="fas fa-sign-out-alt mr-1"></i> Logout</a>
        </div>
        <br><br>
