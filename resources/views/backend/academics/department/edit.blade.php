                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            ...
                            <!-- /.card-header -->
                            <form action="{{ route('admin.academics.department.update', $depart->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="file" data-default-file="{{ asset($depart->thumb) }}"
                                                    name="thumbnail" class="dropify" data-height="100">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="status" required
                                                    ...
                                                    <option {{ $depart->status == 1 ? 'selected' : '' }} value="1">Active
                                                    </option>
                                                    <option {{ $depart->status == 0 ? 'selected' : '' }} value="0">
                                                        Inactive
                                                    </option>
                                                </select>
                                                @error('status')
                                    ...
                                    <div id="allow__seo"
                                        style="display: {{ $depart->meta_title === null && $depart->meta_tag === null && $depart->meta_desc === null ? 'none' : 'block' }}">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-2 text-md-right">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="meta_title"
                                                        placeholder="Enter meta title..." value="{{ $depart->meta_title }}"
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="meta_description" class="form-control rounded-0" placeholder="Enter meta description..." rows="5">{{ $depart->meta_desc }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="checkbox"
                                                    {{ $depart->meta_title === null && $depart->meta_tag === null && $depart->meta_desc === null ? '' : 'checked' }}
                                                    id="allow">
