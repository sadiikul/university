                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Slug</th>
                                            <th>Status</th>
                                            @if ($user->can('department.edit') || $user->can('department.delete'))
                                                <th>Action</th>
                                            @endif
                                        </tr>
                                    </thead>
                                                ...
                                                @if ($user->can('department.edit') || $user->can('department.delete'))
                                                    <td>
                                                        @if ($user->can('department.edit'))
                                                            <a title="Edit"
                                                                href="{{ route('admin.academics.department.edit', $item->id) }}"
                                                                class="text-info mx-1"><i class="fas fa-edit"></i></a>
                                                        @endif
                                                        @if ($user->can('department.delete'))
                                                            <a title="Delete"
                                                                onclick="return confirm('Are you sure to Delete?')"
                                                                href="{{ route('admin.academics.department.destroy', $item->id) }}"
