                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.program.subject.index') }}">Subject Details</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            ...
                            <!-- /.card-header -->
                            <form action="{{ route('admin.program.subject.update', $subject->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
