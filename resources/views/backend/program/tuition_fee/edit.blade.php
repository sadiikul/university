    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tuition Fee Edit</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.program.tuition.index') }}">Tuition
                                    Fee</a>
                            </li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Edit Tuition Fee</h3>
                                <a href="{{ route('admin.program.tuition.index') }}" class="btn btn-sm btn-info"><i
                                        class="fas fa-arrow-left"></i> Back</a>
                            </div>
                            <!-- /.card-header -->
                            <form action="{{ route('admin.program.tuition.update', $tuition->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                            ...
                                            <div class="col-md-9">
                                                <select name="program" required
                                                    ...
                                                    @foreach ($program as $item)
                                                        <option {{ $item->id === $tuition->program_id ? 'selected' : '' }}
