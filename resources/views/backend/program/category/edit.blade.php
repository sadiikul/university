                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('admin.program.category.index') }}">Category</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            ...
                            <!-- /.card-header -->
                            <form action="{{ route('admin.program.category.update',$cate->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" required name="name"
                                                    placeholder="Enter category name..." value="{{ $cate->name }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="status" required
                                                    ...
                                                    <option {{ $cate->status == 1 ? 'selected' : '' }} value="1">Active
                                                    </option>
                                                    <option {{ $cate->status == 0 ? 'selected' : '' }} value="0">
                                                        Inactive
                                                    </option>
                                                </select>
                                                @error('status')
