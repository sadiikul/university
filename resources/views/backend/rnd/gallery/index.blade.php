                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                @if ($user->can('rnd_gallery.create'))
                                    <a href="{{ route('admin.rnd.gallery.create') }}" class="btn btn-sm btn-primary"><i
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            <th>SL</th>
                                            <th>Image</th>
                                            @if ($user->can('rnd_gallery.delete'))
                                                <th>Action</th>
                                            @endif
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($gallery as $item)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset($item->img) }}" width="80" alt="R & D Image">
                                                </td>
                                                @if ($user->can('rnd_gallery.delete'))
                                                    <td>
                                                        <a title="Delete"
                                                            onclick="return confirm('Are you sure to Delete?')"
                                                            href="{{ route('admin.rnd.gallery.destroy', $item->id) }}"
