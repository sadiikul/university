                    ...
                    <div class="col-12">
                        <div class="card rounded-0 card-outline card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Calender Table</h3>
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Year</th>
                                            <th>Status</th>
                                            @if ($user->can('calender.edit') || $user->can('calender.delete'))
                                                <th>Action</th>
                                            @endif
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($year as $item)
                                            <tr>
                                                ...
                                                @if ($user->can('calender.edit') || $user->can('calender.delete'))
                                                    <td>
                                                        @if ($user->can('calender.edit'))
                                                            <a title="Edit"
                                                                href="{{ route('admin.admission.calender.edit', $item->id) }}"
                                                                class="text-info mx-1"><i class="fas fa-edit"></i></a>
                                                        @endif
                                                        @if ($user->can('calender.delete'))
                                                            <a title="Delete"
                                                                onclick="return confirm('Are you sure to Delete?')"
                                                                href="{{ route('admin.admission.calender.destroy', $item->id) }}"
