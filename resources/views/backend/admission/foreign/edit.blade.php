                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card rounded-0 card-outline card-primary">
                            ...
                            <!-- /.card-header -->
                            <form action="{{ route('admin.admission.foreign.fee.update', $fee->id) }}" method="POST"
                                            ...
                                            <div class="col-md-9">
                                                <select name="program" required
                                                    ...
                                                    @foreach ($program as $item)
                                                        <option {{ $item->id === $fee->program_id ? 'selected' : '' }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" required name="duration"
                                                    placeholder="Enter duration..." value="{{ $fee->duration }}"
